...
const Pesquisa = () => {
    ...
    return (
        <div className='pt-6'>
            ...
            <p className='text-center mb-6'>O restaurante X sempre busca por atendender melhor seus cliente.<br />
                Por isso sempre estamos abertos para ouvir a sua opinião.</p>
                    ...
                    {notas.map(nota => {
                        return (
                            <label className='block w-1/6 text-center'>{nota}<br />
                                <input type='radio' onChange={onChange} name='Nota' value={nota} />
                            </label>
                        )
                    })
                    }
